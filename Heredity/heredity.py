    ...
    for p in people:
        ...
        if mother is None and father is None:
         gene_prob = PROBS["gene"][gene_count] 
            ...
            from_mother=pass_p(mother)
            from_father=pass_p(father)

            if gene_count == 2:
                gene_prob= from_mother * from_father
            elif gene_count == 1:
                gene_prob = (from_mother * (1-from_father))+(from_father*(1-from_mother))
            else:
                gene_prob= (1-from_mother)*(1-from_father)

        has_trait= p in have_trait
        join *= gene_prob * PROBS['trait'][gene_count][has_trait]
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities:
        ...
        probabilities[person]['gene'][gene_cout]+=p
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for count in probabilities[person]['trait']:
            probabilities[person]['trait'][count]/=trait_total
